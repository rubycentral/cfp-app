...
describe ProgramSession do
  ...
  it "responds to .create_draft_from_proposal" do
    expect(ProgramSession).to respond_to(:create_draft_from_proposal)
  end
  ...
  describe "#create_draft_from_proposal" do

    it "creates a new program session with the same title as the given proposal" do
      session = ProgramSession.create_draft_from_proposal(proposal)
    ...
    it "does not overwrite speaker_name if it already has a value" do
      ...
      ProgramSession.create_draft_from_proposal(my_proposal)
      ps_speaker = my_proposal.speakers.first
