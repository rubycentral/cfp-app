...
feature "Event Guidelines", type: :system do
  ...
  context "An admin organizer" do
    ...
    it "can edit event guidelines", js: true do
      ...
      expect(page).to have_link "Edit Guidelines"
      ...
      fill_in "event_guidelines", with: "New Guidelines!"
      ...
      click_on "Edit Guidelines"
      fill_in "event_guidelines", with: "BLARG"
      click_on "Cancel"
  ...
  context "A reviewer" do
    ...
    it "cannot edit event guidelines", js: true do
      ...
      expect(page).to_not have_link "Edit Guidelines"
      expect(page).to have_content "We want all the good talks!"
    end
  end
